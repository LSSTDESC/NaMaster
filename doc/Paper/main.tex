...
\begin{abstract}
  The pseudo-$C_\ell$ is an algorithm for estimation of the angular
  ...
  \nmt, a public, validated, robust, accurate and easy-to-use software
  ...
  and requiring $B$- or $E$-mode purification, both in the sphere or
  ...
  bias. \nmt~can be found at \url{add_url}, and is provided with
  comprehensive documentation and a number of code examples to
  maximize its usefulness in the community.
\end{abstract}
...
\maketitlepost
  ...
  aimed at designing optimal and efficient power spectrum estimators.
  ...
  \section{The pseudo-\texorpdfstring{$C_\ell$}{Cl} estimator}\label{sec:maths}
    ...
    reddening, as long as relation is local in space, we get a linear
    ...
    specific for the spin-2 fields.
      ...
      \subsection{Beams and noise}\label{ssec:maths.beam_noise}
        ...
        \subsubsection{Beam deconvolution}\label{sssec:maths.beam_noise.beam}
          ...
          of the beams for maps $a$ and $b$. Note that due to hairy
          ball theorem, it is impossible to have an anisotropic beam
          ...
          estimator to a a set of mock input maps with the same
          ...
          the ration. \as{How does this interact with E/B purification?}
      ...
      \subsubsection{Galaxy clustering and weak lensing} \label{sssec:validation.suite.lss}
        ...
        \begin{itemize}
          ...
          \item {\bf Mask:} for the full-sky data, we use a mask built
            ...
            default version of this mask is not binary, but tracers
