...
cl_decoupled=wsp.decouple_cell(cl_coupled,
  ...
  \section{Discussion}\label{sec:discussion}
    ...
    \nmt is open-source software and publicly available at \url{add_url}. To maximize the usefulness of this software for the community, it is accompanied by an extensive documentation and example code\footnote{See \url{add_url}.}. \nmt~is written in {\tt C} and {\tt OpenMP}-parallelized to maximize its performance, although we encourage its use through the companion {\tt python} wrapper, the fastest-growing language of choice in the analysis of astronomical data.
