...
if (o.whichfig==1) or (o.whichfig==-1) :
    ...
    plt.figure()
    ax=plt.gca()
    ax.plot(l,cltt,'-',c='r',lw=2,label='$\\delta\\times\\delta$')
    ax.plot(l,clte,'-',c='g',lw=2,label='$\\delta\\times\\gamma^E$')
    ax.plot(l,clee,'-',c='b',lw=2,label='$\\gamma^E\\times\\gamma^E$')
    ax.plot(l,nltt,'--',c='r',lw=2)
    ax.plot(l,nlte,'--',c='g',lw=2)
    ax.plot(l,nlee,'--',c='b',lw=2)
