...
export HOMEBREW_NO_AUTO_UPDATE=1; brew install gcc8; export CC=gcc-8; brew install fftw --with-openmp --without-fortran; brew install autoconf; brew install cfitsio; 
