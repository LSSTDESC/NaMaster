...
void run_master(nmt_field_CAR *fl1,nmt_field_CAR *fl2,
		char *fname_cl_noise,
		...
		int n_lbin)
{
  ...
  nmt_workspace_CAR *w;
  if(0 == 1) { //If file exists just read matrix
...
int main(int argc,char **argv)
{
  ...
  fl1=nmt_field_CAR_read(fname_mask_1,fname_map_1,fname_temp_1,fname_beam_1,pol_1,pure_e_1,pure_b_1,10,1E-10);
  ...
  if(!strcmp(fname_map_2,"none")) {
    ...
    fl2=nmt_field_CAR_read(fname_mask_2,fname_map_2,fname_temp_2,fname_beam_2,pol_2,pure_e_2,pure_b_2,10,1E-10);
  }
